...
# Script to run LedgerLink Customer Services app tests with Docker and PostgreSQL
...
echo "=== Running LedgerLink Customer Services Tests with PostgreSQL ==="
...
if [ $EXIT_CODE -eq 0 ]; then
  echo "=== All Customer Services tests passed! ==="
else
  echo "=== Customer Services tests failed with exit code $EXIT_CODE ==="
fi
