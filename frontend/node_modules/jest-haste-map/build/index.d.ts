...
import HasteModuleMap from '../src/ModuleMap';
import type { HasteMapStatic, HasteRegExp, InternalHasteMap, HasteMap as InternalHasteMapObject, SerializableModuleMap } from '../src/types';
...
export { default as ModuleMap } from '../src/ModuleMap';
export type { SerializableModuleMap } from '../src/types';
export type { IModuleMap } from '../src/types';
export type { default as FS } from '../src/HasteFS';
export type { ChangeEvent, HasteMap as HasteMapObject } from '../src/types';
/**
...
export default class HasteMap extends EventEmitter {
    ...
    static H: import("../src/types").HType;
}
