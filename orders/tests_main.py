...
# Check if we should skip materialized view tests
...
class OrderModelTests(TestCase):
    ...
    def setUp(self, generate_transaction_id=None):
        """Set up test data"""
        # Use the fixture if provided, otherwise generate a random ID
        if generate_transaction_id:
    ...
    def test_get_sku_details(self, monkeypatch):
        ...
        try:
            ...
            if not view_exists and not should_skip_materialized_view_tests():
                pytest.skip("OrderSKUView materialized view does not exist")
        except Exception:
            # If we can't check, use the mocked version
            pass
...
@pytest.mark.django_db
@pytest.mark.skipif(should_skip_materialized_view_tests(), reason="Materialized views tests skipped")
class OrderSKUViewTest(TestCase):
    """Tests for the OrderSKUView model."""
    ...
    def test_db_table_name(self):
        ...
        self.assertEqual(OrderSKUView._meta.db_table, 'orders_orderskuview')
...
class OrderAPITests(APITestCase):
    ...
    def setUp(self):
        ...
        self.another_customer = Customer.objects.create(
            ...
            legal_business_name="Jane Smith",
